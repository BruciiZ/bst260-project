...
In this study, we analyzed COVID-19 data across the United States from January 2020 to November 2024, focusing on evaluating state-level performance during the pandemic. Our approach combined statistical modeling, excess mortality estimation, and comparisons across three defined pandemic waves. We divided the entire periods into 3 waves where a peak in cases, deaths, and hospitalizations can be observed. The first one occurs from Oct. 2020 to Apr. 2021, And other two waves are between Jul. 2021 to early Dec. 2021 and between from early Dec. 2021 to Apr. 2022. We used pre-pandemic mortality models based on historical data (2015–2019) to estimate expected deaths if COVID-19 did not happen, which we provided a standard baseline to identify excess mortality caused by COVID-19.
