...
combined_data <- combined_data |>
  rename(
    State = state_name,
    Excess_mortality = total_excess_deaths,
    Excess_mortality_rate_per100k = excess_death_rate,
) 
