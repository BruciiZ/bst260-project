...
combined_data <- combined_data |>
  rename(
    ...
    excess_mortality_rate = excess_death_rate
) 

# View the combined data
kable(combined_data, digit = 3)
```
...
In this study, we analyzed COVID-19 data across the United States from January 2020 to November 2024, focusing on evaluating state-level performance during the pandemic. Our approach combined statistical modeling, excess mortality estimation, and comparisons across three defined pandemic waves.
