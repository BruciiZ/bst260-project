...
Total cases peaked in Wave 3, while total deaths and hospitalizations decreased relative to Wave 1.
The Case Fatality Rate (CFR) showed a marked decline across waves, decreasing from 1,553.42 in Wave 1 to 632.79 in Wave 3.
The Hospitalization Rate (HR) also declined significantly by Wave 3, from 7,654.67 in Wave 1 to 3,853.12 in Wave 3.
Death Proportion (DP) decreased steadily across the waves, dropping from 103.90 in Wave 1 to 57.82 in Wave 3.
...
Overall Patterns:
Consistently High Excess Mortality States:
States like Oklahoma, Mississippi, and West Virginia frequently appeared among the highest excess mortality ranks. Possible reasons include challenges such as lower vaccination uptake, fewer healthcare resources in rural regions, delayed or less stringent public health measures, and possibly higher prevalence of pre-existing health conditions.
Consistently Low Excess Mortality States:
Hawaii, Washington, and Massachusetts repeatedly ranked among the states with the lowest excess mortality. These states are known for stronger healthcare infrastructure, better access to medical services, early and sustained public health interventions, and higher vaccination rates. Compliance with mitigation measures and strategic public policies likely helped keep mortality rates lower.
Influence of Public Health Policies and Vaccination:
Over time, the availability and uptake of vaccines played a crucial role. States that improved vaccine coverage tended to see decreasing excess mortality in later waves, while states slower to vaccinate or implement effective preventive measures often struggled.
